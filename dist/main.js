...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Display)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/crud.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\r\nconst todoList = document.querySelector('.todo-list');\r\n\r\nclass Display {\r\n  loadTasks() {\r\n    const createItem = (task) =>\r\n      `<div class=\"todo-item\">\r\n           <div class=\"below\" id=${task.index}>\r\n               <input\r\n                type=\"checkbox\" \r\n                name=\"box\" \r\n                class=\"checkbox\" ${task.completed ? 'checked' : ''}\r\n                id=${task.index}>\r\n               <input \r\n               id=\"${task.index}\" \r\n               class=${task.completed ? 'checked task' : 'task'} \r\n               value=\"${task.description}\"\r\n               type=\"text\">\r\n           </div>\r\n           <button class=\"remove-button\" id=${task.index}><i class=\"fa-solid fa-trash-can\"></i></button> \r\n       </div>`;\r\n\r\n    this.getLS();\r\n    todoList.innerHTML = '';\r\n    this.todos.forEach((task) => todoList.insertAdjacentHTML('beforeend', createItem(task)));\r\n    const check = document.querySelectorAll('.checkbox');\r\n    const task = todoList.querySelectorAll('.task');\r\n\r\n    check.forEach((checkbox, id) => {\r\n      checkbox.addEventListener('change', () => {\r\n        if (checkbox.checked) {\r\n          task[id]?.classList.add('checked');\r\n          this.todos = this.todos.map((task) => {\r\n            if (task.index === parseInt(checkbox.parentElement.id, 10)) {\r\n              task.completed = true;\r\n            }\r\n            return task;\r\n          });\r\n          Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/crud.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\r\n        } else {\r\n          task[id]?.classList.remove('checked');\r\n          this.todos = this.todos.map((task) => {\r\n            if (task.index === parseInt(checkbox.parentElement.id, 10)) {\r\n              task.completed = false;\r\n            }\r\n            return task;\r\n          });\r\n          Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/crud.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\r\n        }\r\n      });\r\n    });\r\n\r\n    const removeBtn = document.querySelectorAll('.remove-button');\r\n    removeBtn.forEach((btn) => {\r\n      btn.addEventListener('click', (e) => {\r\n        e.preventDefault();\r\n        const { id } = e.currentTarget;\r\n        this.remove(id);\r\n        Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/crud.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\r\n        todoList.innerHTML = '';\r\n        Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/crud.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this.todos);\r\n      });\r\n    });\r\n\r\n    task.forEach((textarea) => {\r\n      textarea.addEventListener('change', () => {\r\n        const result = this.todos.filter((task) => task.index === Number(textarea.id));\r\n        this.todos[result[0].index - 1].description = textarea.value;\r\n        Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/crud.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\r\n      });\r\n    });\r\n  }\r\n}\n\n//# sourceURL=webpack://to-do-list/./src/modules/display.js?");
